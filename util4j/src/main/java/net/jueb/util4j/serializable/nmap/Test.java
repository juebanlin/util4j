package net.jueb.util4j.serializable.nmap;
...
import net.jueb.util4j.serializable.nmap.type.NBoolean;
import net.jueb.util4j.serializable.nmap.type.NInteger;
import net.jueb.util4j.serializable.nmap.type.NMap;
import net.jueb.util4j.serializable.nmap.type.NUTF8String;
