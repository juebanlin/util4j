package net.jueb.util4j.serializable;
...
import net.jueb.util4j.serializable.bytesMap.DataToMap;
import net.jueb.util4j.serializable.bytesMap.MapToData;
import net.jueb.util4j.tools.io.FileStreamBytes;
