...
public class MultiNettyClient extends AbstractNettyClient{
	
	protected final MultiNettyClientConfig config;
	/**
	 * 业务处理handler
	 */
	protected final ChannelHandler handler;
	
	public MultiNettyClient(MultiNettyClientConfig config,InetSocketAddress target,ChannelHandler handler) {
		super(target);
	...
	public MultiNettyClient(MultiNettyClientConfig config,String host,int port,ChannelHandler handler) {
