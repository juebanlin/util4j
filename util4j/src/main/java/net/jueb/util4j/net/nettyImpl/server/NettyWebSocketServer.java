...
import net.jueb.util4j.net.nettyImpl.handler.websocket.DefaultWebSocketServerInitializer;
...
public class NettyWebSocketServer extends NettyServer{
	...
	protected ChannelHandler fixHandlerBeforeDoBooterBind(ChannelHandler handler) {
		ChannelHandler result=new DefaultWebSocketServerInitializer(websocketPath, sslCtx,handler);
		return result;
	}
}
