...
public class NodeX<T> {
	...
	private NodeX<T>[] sub=new NodeX[4];
	private T fruit;//附件
	
	private T _get(int index,int pos)
	{
		if(pos<0)
		{//超出范围
			return null;
	...
	private void _set(int index,int pos,T value)
	{
		if(pos<0)
		{//超出范围
			return ;
	...
	public static class Test{
		...
		public void test1()
		{
			NodeX<Byte> node=new NodeX<Byte>();
			int key=1001;
		    Byte value=123;
		    node.set(key,value);
