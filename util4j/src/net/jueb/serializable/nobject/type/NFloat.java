...
public final class NFloat extends NObjectBase implements NObject{
	 ...
	 * 一个字节
	 */
	public static final byte flagHead=FlagHead.NFloat;
	/**
	 * 标记尾
	 * null表示无结尾或者直到遇到下一个head标记
	 */
	public static final byte[] flagEnd=FlagEnd.NFloat;
	...
	public static NFloat valueOf(Float arg)
	{
	...
	public byte[] valueBytes() {
		return tb.FloatToByteArray(this.value);
	}
	@Override
	 ...
	 * @return
	 */
	public static NFloat of(Float obj) {
		return new NFloat(obj);
	}
	/**
	 ...
	 */
	public static NFloat of(byte[] bytes, P p)
	{
		//参数不符合要求
		...
		if(canReadLength(bytes, p,5))
		{
			...
			{
				return new NFloat(tb.ByteArrayToFloat(hsb.subByteArray(i, 1, 5-1)));
			}
		}
		return null;
	}
