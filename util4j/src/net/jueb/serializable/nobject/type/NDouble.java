...
public final class NDouble extends NObjectBase implements NObject{
	 ...
	 * 一个字节
	 */
	public static final byte flagHead=FlagHead.NDouble;
	/**
	 * 标记尾
	 * null表示无结尾或者直到遇到下一个head标记
	 */
	public static final byte[] flagEnd=FlagEnd.NDouble;
	...
	public static NDouble valueOf(Double arg)
	{
	...
	public byte[] valueBytes() {
		return tb.DoubleToByteArray(this.value);
	}
	@Override
	 ...
	 * @return
	 */
	public static NDouble of(Double obj) {
		return new NDouble(obj);
	}
	 ...
	 */
	public static NDouble of(byte[] bytes, P p)
	{
		//参数不符合要求
		...
		if(canReadLength(bytes, p,9))
		{
			...
			{
				return new NDouble(tb.ByteArrayToDouble(hsb.subByteArray(i, 1, 9-1)));
			}
		}
		return null;
	}
