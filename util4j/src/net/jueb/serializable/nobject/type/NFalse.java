...
public final class NFalse extends NObjectBase implements NObject{
	 ...
	 * 一个字节
	 */
	public static final byte flagHead=FlagHead.NFalse;
	/**
	 * 标记尾
	 * null表示无结尾或者直到遇到下一个head标记
	 */
	public static final byte[] flagEnd=FlagEnd.NFalse;
	 ...
	 */
	public static NFalse of(byte[] bytes, P p)
	{
		//参数不符合要求
