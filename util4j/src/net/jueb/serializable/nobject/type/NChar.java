...
public final class NChar extends NObjectBase implements NObject{
	 ...
	 * 一个字节
	 */
	public static final byte flagHead=FlagHead.NChar;
	/**
	 * 标记尾
	 * null表示无结尾或者直到遇到下一个head标记
	 */
	public static final byte[] flagEnd=FlagEnd.NChar;
	...
	public static NChar valueOf(Character arg)
	{
	...
	public byte[] valueBytes() {
		return tb.CharToByteArray(this.value);
	}
	@Override
	 ...
	 * @return
	 */
	public static NChar of(Character obj) {
		return new NChar(obj);
	}
	 ...
	 */
	public static NChar of(byte[] bytes, P p)
	{
		//参数不符合要求
		...
		if(canReadLength(bytes, p,3))
		{
			...
			{
				return new NChar(tb.ByteArrayToChar(new byte[]{i[1],i[2]}));
			}
		}
		return null;
	}
